# Usage example:
# powershell -WindowStyle Hidden -ExecutionPolicy Bypass -File "input-ON.ps1"
...
$valueFilePath = "C:\Users\Ovidiu\Desktop\EventsToSpadNext\resources\events\demo\values\on.val"
